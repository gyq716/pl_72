...
def main(args=None):
    ...
    if args.snapshot is not None:
        ...
        training_model = retinanet_vocab_w2v.retinanet_bbox(inputs=inputs, num_classes=72, backbone=resnet)
        # compile model
        training_model.compile(
            loss={
                'regression'    : losses.smooth_l1(),
    ...
    # inputs = keras.layers.Input(shape=(None, None, 3))
    # cocomodel_resnet = keras_resnet.models.ResNet50(inputs, include_top=False, freeze_bn=True)
    # cocomodel65 = retinanet.retinanet_bbox(inputs=inputs, num_classes=72, backbone=cocomodel_resnet)
    # cocomodel65.load_weights('coco72/resnet50_csv_11.h5')
    #
    ...
    #         print i
    training_model.load_weights('Model/resnet50_csv_30.h5')
    print('yes')
