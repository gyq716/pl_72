...
from keras_retinanet.models import retinanet as retinanet_old
...
def parse_args(args):
    ...
    parser.add_argument('--top', help='Top seen word vectors', default=25, type=int)
    parser.add_argument('--save-path', help='Path for saving images with detections.', default="gzsd/")
